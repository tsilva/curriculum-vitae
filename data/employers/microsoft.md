...
links:
  - label: Microsoft Dynamics AX
    url: https://dynamics.microsoft.com/en-us/ax/
  - group: 'TV news coverage about being hired by Microsoft straight out of college (oh the cringe! 😬) :'
    links:
      - label: RTP 1
        url: https://photos.app.goo.gl/jo7DskprCoxt2jB77
      - label: SIC
