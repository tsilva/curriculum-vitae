...
## Tynker - Block IDE - Major redesign/overhaul
...
Lynker was developed as part of an inniative to build collaboration features into Tynker. To do so, I required a real-time messaging server. Existing services were not cost-effective enough for the use cases we were foreseeing (eg: Pusher), so ended up writing one from scratch.

Stack: NodeJS, Express, socket.io, Redis, NGINX
Team: Just me

## Block IDE - Project Sharing
...
Stack: PHP, Javascript, Redux, Redux Saga, AngularJS
...
This project was done as a flagship product from Tynker to showcase during the FIFA World Cup 2023, which was sponsored by BYJU's. This project was done in very little time.
...
**Links:**
- Product: https://kustomize.karl.com/
...
**Links:**
- Product: https://www.lugardajoia.com/
...
Jan 2014 - PresentJan 2014 - Present
**Technologies:** iOS / Objective-C
...
## Rocklobby iOS (Mobile Music Social Network for Fans, Artists and Venues)
...
## Fresh Deck Poker (Massive Multiplayer Social Game)
...
Deeloped some core backend features and frontend features.
