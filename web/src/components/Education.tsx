...
export function Education({ entries }: EducationProps) {
  return (
    <section id="education" className="max-w-4xl mx-auto px-6 py-20">
      <h2 className="font-[family-name:var(--font-display)] text-3xl md:text-4xl font-bold text-amber mb-10 reveal">
        Education
      </h2>
          ...
          >
            <div className="flex items-start gap-3 mb-3">
              ...
              <div className="min-w-0">
                <h3 className="font-[family-name:var(--font-display)] text-base font-bold text-warm-white">
                  {entry.url ? (
                    <a
                      href={entry.url}
                      target="_blank"
            ...
            <div className="font-[family-name:var(--font-mono)] text-xs text-slate space-y-0.5">
