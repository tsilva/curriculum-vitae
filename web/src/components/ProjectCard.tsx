...
export function ProjectCard({ project, onClick }: ProjectCardProps) {
  return (
    ...
    >
      ...
      <span className="absolute top-1 left-2 text-cyan/30 font-[family-name:var(--font-mono)] text-xs select-none">&#x250C;&#x2500;</span>
      <span className="absolute top-1 right-2 text-cyan/30 font-[family-name:var(--font-mono)] text-xs select-none">&#x2500;&#x2510;</span>
      <span className="absolute bottom-1 left-2 text-cyan/30 font-[family-name:var(--font-mono)] text-xs select-none">&#x2514;&#x2500;</span>
      <span className="absolute bottom-1 right-2 text-cyan/30 font-[family-name:var(--font-mono)] text-xs select-none">&#x2500;&#x2518;</span>
