...
export function Hero({ ossCount }: HeroProps) {
  ...
  return (
    ...
    >
      ...
      <div className="mt-3 flex w-full max-w-[18rem] items-center justify-center px-2 sm:max-w-[21rem] md:max-w-xl md:px-0">
      ...
      {/* Social links */}
      <div className="mt-4 flex flex-wrap justify-center gap-3 sm:mt-8 sm:gap-4 md:mt-12">
